...
class MPC():
    def getControlForce(self, now: int) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getControlForceNow(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getRemainingPlanBufferMillis(self) -> int: ...
    def recordGroundTruthState(self, time: int, pos: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], vel: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], mass: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None: ...
    def recordGroundTruthStateNow(self, pos: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], vel: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], mass: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None: ...
