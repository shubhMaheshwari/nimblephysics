...
class BackpropSnapshot():
    ...
    def backpropState(self, world: nimblephysics_libs._nimblephysics.simulation.World, nextTimestepStateLossGrad: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None, exploreAlternateStrategies: bool = False) -> LossGradientHighLevelAPI: ...
    def benchmarkJacobians(self, world: nimblephysics_libs._nimblephysics.simulation.World, numSamples: int) -> None: ...
    def finiteDifferenceForceVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, useRidders: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def finiteDifferencePosPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, subdivisions: int, useRidders: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def finiteDifferenceVelPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, subdivisions: int, useRidders: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def finiteDifferenceVelVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, useRidders: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getActionJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getControlForceVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getInvMassMatrix(self, arg0: nimblephysics_libs._nimblephysics.simulation.World, arg1: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getMassMatrix(self, arg0: nimblephysics_libs._nimblephysics.simulation.World, arg1: bool) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getMassVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    ...
    def getStateJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getVelPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getVelVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    pass
...
class Mapping():
    def getControlForceDim(self) -> int: 
        ...
        """
    def getControlForceLowerLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getControlForceUpperLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getControlForces(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getPosDim(self) -> int: 
        ...
        """
    def getPositionLowerLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getPositionUpperLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getPositions(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getRealForceToMappedForceJac(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: 
        """
        ...
        """
    def getRealPosToMappedPosJac(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: 
        """
        ...
        """
    def getRealPosToMappedVelJac(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: 
        """
        ...
        """
    def getRealVelToMappedPosJac(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: 
        """
        ...
        """
    def getRealVelToMappedVelJac(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: 
        """
    ...
    def getVelDim(self) -> int: 
        ...
        """
    def getVelocities(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getVelocityLowerLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def getVelocityUpperLimits(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def setControlForces(self, world: nimblephysics_libs._nimblephysics.simulation.World, forces: typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]", "flags.writeable"]) -> None: ...
    def setPositions(self, world: nimblephysics_libs._nimblephysics.simulation.World, positions: typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]", "flags.writeable"]) -> None: ...
    def setVelocities(self, world: nimblephysics_libs._nimblephysics.simulation.World, velocities: typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]", "flags.writeable"]) -> None: ...
    pass
...
class KnotJacobian():
    ...
    def torquesEndPos(self, arg0: list[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]]) -> None:
        pass
    @property
    ...
    def torquesEndVel(self, arg0: list[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]]) -> None:
        pass
    pass
class LossGradient():
    def __init__(self) -> None: ...
...
class MappedBackpropSnapshot():
    ...
    def getControlForceMappedVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getControlForceVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getMappings(self) -> list[str]: ...
    def getMassMappedVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getMassVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosMappedPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosMappedVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getPosVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    ...
    def getVelMappedPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getVelMappedVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, mapAfter: str = 'identity', perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getVelPosJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    def getVelVelJacobian(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]: ...
    pass
...
class WithRespectTo():
    ...
    @typing.overload
    def get(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    @typing.overload
    def get(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def lowerBound(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    def name(self) -> str: ...
    @typing.overload
    def set(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None: ...
    @typing.overload
    def set(self, world: nimblephysics_libs._nimblephysics.simulation.World, value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None: ...
    def upperBound(self, world: nimblephysics_libs._nimblephysics.simulation.World) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    pass
...
class WithRespectToMass():
    def registerNode(self, node: nimblephysics_libs._nimblephysics.dynamics.BodyNode, type: WrtMassBodyNodeEntryType, upperBound: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], lowerBound: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> WrtMassBodyNodyEntry: ...
    pass
...
class WrtMassBodyNodyEntry():
    ...
    def type(self, arg0: WrtMassBodyNodeEntryType) -> None:
        pass
    pass
def convertJointSpaceToWorldSpace(world: nimblephysics_libs._nimblephysics.simulation.World, jointSpace: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], nodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], space: ConvertToSpace, backprop: bool = False, useIK: bool = True) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
    """
