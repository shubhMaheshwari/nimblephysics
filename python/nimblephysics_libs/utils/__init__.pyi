...
class AccelerationTrackAndMinimize():
    def __init__(self, numTimesteps: int, trackAccelerationAtTimesteps: list[bool], zeroUnobservedAccWeight: float = 1.0, trackObservedAccWeight: float = 1.0, regularizationWeight: float = 0.01, dt: float = 1.0, numIterations: int = 10000) -> None: ...
