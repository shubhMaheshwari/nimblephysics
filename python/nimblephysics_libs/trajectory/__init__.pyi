...
class Problem():
    ...
    def getFinalState(self, world: nimblephysics_libs._nimblephysics.simulation.World, perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]: ...
    ...
    def getPinnedForce(self, time: int) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]", "flags.writeable"]: ...
    ...
    def pinForce(self, time: int, value: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"]) -> None: ...
    def removeMapping(self, key: str) -> None: ...
    def setControlForcesRaw(self, forces: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> None: ...
    ...
    def updateWithForces(self, world: nimblephysics_libs._nimblephysics.simulation.World, forces: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None) -> typing.Annotated[numpy.typing.NDArray[numpy.int32], "[m, 1]"]: ...
    pass
