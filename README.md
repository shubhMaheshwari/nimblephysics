...
2. Update `dart/proto/GUI.proto`
	- Add new element in Command, last was set_dropdown_value = 44
...
### Make a draggable-collapsable container to show subject data. 
	- TODO 
		...
		- Multiple-dropdowns with same name for different containers 
		- Screen Resize not working
		- onChange function causes WebSocket Error in c++ that cannot be traced back to python, debugger not working
		- 