...
export namespace dart.proto {
    export class CommandList extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.message_id != 0)
                writer.writeInt32(2, this.message_id);
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.message_id = reader.readInt32();
                        break;
    ...
    export class Command extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("collapsible_container" in data && data.collapsible_container != undefined) {
                    this.collapsible_container = data.collapsible_container;
                }
        ...
        get collapsible_container() {
            return pb_1.Message.getWrapperField(this, CollapsibleContainer, 41) as CollapsibleContainer;
        }
        set collapsible_container(value: CollapsibleContainer) {
            pb_1.Message.setOneofWrapperField(this, 41, this.#one_of_decls[0], value);
        }
        get has_collapsible_container() {
            return pb_1.Message.getField(this, 41) != null;
        }
        get get_string_code() {
            return pb_1.Message.getWrapperField(this, GetStringCode, 42) as GetStringCode;
        }
        set get_string_code(value: GetStringCode) {
        ...
        static fromObject(data: {
            ...
            if (data.collapsible_container != null) {
                message.collapsible_container = CollapsibleContainer.fromObject(data.collapsible_container);
            }
        ...
        toObject() {
            ...
            if (this.collapsible_container != null) {
                data.collapsible_container = this.collapsible_container.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_collapsible_container)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 40:
                        ...
                        break;
                    case 41:
                        reader.readMessage(message.collapsible_container, () => message.collapsible_container = CollapsibleContainer.deserialize(reader));
                        break;
                    case 42:
    ...
    export class CollapsibleContainer extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new CollapsibleContainer({});
            if (data.key != null) {
                message.key = data.key;
            }
            if (data.pos != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CollapsibleContainer {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new CollapsibleContainer();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): CollapsibleContainer {
            return CollapsibleContainer.deserialize(bytes);
        }
    }
    ...
    export class GetStringCode extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("code_result" in data && data.code_result != undefined) {
                    this.code_result = data.code_result;
                }
                if ("key_result" in data && data.key_result != undefined) {
                    this.key_result = data.key_result;
                }
            }
        }
        get key() {
        ...
        get result() {
            const cases: {
                [index: number]: "none" | "code_result" | "key_result";
            } = {
                0: "none",
                3: "code_result",
                4: "key_result"
        ...
        static fromObject(data: {
            ...
            const message = new GetStringCode({});
            if (data.key != null) {
                message.key = data.key;
            }
            if (data.code != null) {
            ...
            if (data.code_result != null) {
                message.code_result = data.code_result;
            }
            if (data.key_result != null) {
                message.key_result = data.key_result;
            }
            return message;
        }
        toObject() {
            ...
            if (this.code_result != null) {
                data.code_result = this.code_result;
            }
            if (this.key_result != null) {
                data.key_result = this.key_result;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_code_result)
                writer.writeInt32(3, this.code_result);
            if (this.has_key_result)
                writer.writeString(4, this.key_result);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetStringCode {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetStringCode();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        message.code_result = reader.readInt32();
                        break;
                    case 4:
                        message.key_result = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): GetStringCode {
            return GetStringCode.deserialize(bytes);
        }
    }
}
